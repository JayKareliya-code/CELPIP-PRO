...
export function WritingModuleHome({ tasks }: WritingModuleHomeProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {isStarter && (
        <div className="relative overflow-hidden rounded-xl border border-emerald-700/40 bg-gradient-to-r from-emerald-950/60 via-emerald-950/40 to-teal-950/40 p-4 flex items-center gap-4 flex-wrap">
          ...
          <Link
            href="/billing"
            className="shrink-0 flex items-center gap-1.5 px-4 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white text-sm font-semibold transition-colors"
          >
            Upgrade
